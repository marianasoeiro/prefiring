...
for nome in nomes:
    ...
    lista_canal.append([
        dict(eta_min= x_min[i],eta_max= x_max[i],pt_min= y_min[i],pt_max= y_max[i],value= value[i],err = err[i])
...
#with open("output_new/L1prefiring_jetemptvseta_2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[1]: lista_canal[1]}
#with open("output_new/L1prefiring_jetptvseta_2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[2]: lista_canal[2]}
#with open("output_new/L1prefiring_photonptvseta_2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[3]: lista_canal[3]}
#with open("output_new/L1prefiring_jetptvseta_2016BtoH.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[4]: lista_canal[4]}
#with open("output_new/L1prefiring_jetemptvseta_2016BtoH.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[5]: lista_canal[5]}
#with open("output_new/L1prefiring_photonptvseta_2016BtoH.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[6]: lista_canal[6]}
#with open("output_new/L1prefiring_jetptvseta_UL2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[7]: lista_canal[7]}
#with open("output_new/L1prefiring_jetemptvseta_UL2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[8]: lista_canal[8]}
#with open("output_new/L1prefiring_photonptvseta_UL2017BtoF.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[9]: lista_canal[9]}
#with open("output_new/L1prefiring_jetptvseta_UL2016preVFP.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[10]: lista_canal[10]}
#with open("output_new/L1prefiring_jetemptvseta_UL2016preVFP.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[11]: lista_canal[11]}
#with open("output_new/L1prefiring_photonptvseta_UL2016preVFP.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[12]: lista_canal[12]}
#with open("output_new/L1prefiring_jetptvseta_UL2016postVFP.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
#dict_salvar = {nomes[13]: lista_canal[13]}
#with open("output_new/L1prefiring_jetemptvseta_UL2016postVFP.json", "w") as f:
    #json.dump(dict_salvar,f,indent=4)
dict_salvar = {nomes[14]: lista_canal[14]}
with open("output_new/L1prefiring_photonptvseta_UL2016postVFP.json", "w") as f:
    json.dump(dict_salvar,f,indent=4)
